...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if boxes.shape == torch.Size([0]):
            raise ValueError('An image with 0 bounding box was given.\nPlease delete that sample from the dataset')
            area = torch.tensor([0])
...
def create_train_dataset():
    ...
    #train_dataset = CustomDataset(TRAIN_DIR, RESIZE_TO, RESIZE_TO, CLASSES, None)
